                            ...
                            child: Column(
                              children: [
                                Container(clipBehavior: Clip.antiAlias,
                                  height: 330,
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(28),color: Colors.black.withOpacity(.9),),
                                  child: Stack(
                                    children: [
                                      Container(
                                          ...
                                          child:
                                              Image.network(movies[index].image,width: double.infinity,height: 300,fit:BoxFit.fill,),),
                                      Container(
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            movies[index].title,style: TextStyle(color: Colors.white),
